...
/**
 * Stripe payment — Create a Stripe PaymentIntent — take a payment.
 *
...
export const STRIPE_PAYMENT_INTENT_OPERATION = "payment_intent_create";

export const STRIPE_PAYMENT_INTENT_META = stripeMeta("action", "take a payment", "https://docs.stripe.com/api/payment_intents/create");
